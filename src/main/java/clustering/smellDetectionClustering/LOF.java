...
//    @Override
    public TechnicalInformation getTechnicalInformation() {
        ...
        result.setValue(TechnicalInformation.Field.AUTHOR, "Markus M. Breunig and Hans-Peter "
    ...
    protected void postFirstBatch(Instance inst) throws Exception {
        ...
        do {
            ...
            double[] distancesAdjust = new double[distances.length];
            for (int k = 0; k< distances.length; k++){
                if (distances[k]==0){
                    distancesAdjust [k] = 0.01;
                }
                else{
                    distancesAdjust [k] = distances[k];
                }
            }

            currentN.m_distances = distancesAdjust;
                ...
                for (int i = m_start; i < m_end; i++) {
                    ...
                    if (addToKDistanceContainer(key, n)) {
                        ...
                        do {
                            ...
                            double[] distances = m_search.getDistances();
                            double[] distancesAdjust = new double[distances.length];
...
//    @Override
    ...
    public String getRevision() {
        return RevisionUtils.extract("$Revision: 9879 $");
    }
