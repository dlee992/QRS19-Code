...
public class DefaultClusteringAlgorithm implements ClusteringAlgorithm {
	...
	public List<Cluster> performClustering(double[][] distances,
                                           String[] clusterNames, LinkageStrategy linkageStrategy, double eps) {
    ...
    int mergeCount = 0;
    while (!builder.isTreeCut(eps)) {
    	//System.out.print("merge Count " + ++mergeCount);
      builder.agglomerate(linkageStrategy);
    }

    return builder.getClusters();
  }
